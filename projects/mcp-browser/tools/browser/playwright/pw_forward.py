...
def pw_forward(page_index: int = None, cdp_url: str = "http://localhost:9222", page_url: str = None) -> dict:
    """
    ...
    Returns:
        ...
        - status: "ok" or "error"
        - url: The URL after going forward
        - title: The page title after going forward
...
"""
    return run_node(script, timeout=30, err_timeout="Go forward timed out")
